...
install -D -m 0644 rpm/pgmoneta-mcp.conf %{buildroot}%{_sysconfdir}/pgmoneta-mcp/pgmoneta-mcp.conf
install -D -m 0644 rpm/pgmoneta-mcp-users.conf %{buildroot}%{_sysconfdir}/pgmoneta-mcp/pgmoneta-mcp-users.conf
install -D -m 0644 rpm/pgmoneta-mcp.service %{buildroot}%{_unitdir}/pgmoneta-mcp.service
